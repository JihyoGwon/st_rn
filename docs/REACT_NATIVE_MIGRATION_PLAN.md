...
- [x] 메시지 버블 컴포넌트
- [x] 입력창 구현
- [x] 메시지 리스트 표시 (FlashList 사용)

#### Week 4: 채팅 기능 구현

**Day 1-2: 메시지 전송/수신**
- [x] 메시지 준비 API 연동 (/api/chats/prepare-messages)
- [x] 메시지 생성 API 연동 (/api/backends/chat-completions/generate)
- [x] 응답 처리 및 표시 (비스트리밍)
...
**Day 5: 채팅 저장/로드**
- [x] 채팅 저장 기능 (/api/chats/save)
- [x] 채팅 히스토리 로드 (/api/chats/get)
- [x] 최근 채팅 목록 (기본 채팅만 지원, 목록 기능은 미구현)
